...
export default function Home() {
    const sectionHeaderRefs = [useRef<HTMLDivElement>(null), useRef<HTMLDivElement>(null), useRef<HTMLDivElement>(null),]
        ...
        <>
            ...
            <div
                ...
                <div className="h-full flex flex-col pt-12 justify-between">
                    ...
                    <div
                        className="rounded-full backdrop-blur-sm bg-white/5 h-[60px] border border-white/40 flex justify-center items-center">
                        <LogoutSVG/>
                    </div>
                </div>
                <div
                ...
                >
                    ...
                    <div className="grid grid-cols-[1fr_1fr_1fr] grid-rows-[300px_200px] gap-5 mb-10">
                        <div
                            className="w-full h-full backdrop-blur-sm bg-white/5 p-6 rounded-2xl shadow-lg relative col-span-2">
                            <div
                                className="absolute top-0 left-0 w-full h-full border border-[#d0ffffa1] mask-gradient-2 rounded-2xl"/>
                        </div>
                        ...
                        <div
                            className="w-full h-full backdrop-blur-sm bg-white/5 p-6 rounded-2xl shadow-lg relative col-span-3">
                            <div
                                className="absolute top-0 left-0 w-full h-full border border-[#d0ffffa1] mask-gradient-2 rounded-2xl"/>
                        </div>
                    </div>
                ...
                <div className="w-full h-full backdrop-blur-sm bg-white/5 p-6 mt-12 rounded-2xl shadow-lg relative">
                    <div
                        className="absolute top-0 left-0 w-full h-full border border-[#d0ffffa1] mask-gradient rounded-2xl"/>
